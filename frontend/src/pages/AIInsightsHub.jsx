...
export const AIInsightsHub = () => {
  ...
  const handleSendChat = async (messageText) => {
    ...
    try {
      const res = await axios.post('https://smart-logistics-backend-mefz.onrender.com/api/chat', { message: textToSend });
  ...
  const handleOptimize = async (type) => {
    ...
    try {
      const res = await axios.get(`https://smart-logistics-backend-mefz.onrender.com/api/optimize?type=${type}`);
  ...
  const handleDiagnoseOrder = async (id) => {
    ...
    try {
      const res = await axios.get(`https://smart-logistics-backend-mefz.onrender.com/api/delay-explanation?order_id=${idToSearch}`);
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      const res = await axios.get('https://smart-logistics-backend-mefz.onrender.com/api/generate-report');
